...
const AboutMe = () => {
    return (
        <div className="bg-[#03a9fc] 2xl:py-20 md:py-15 py-10 2xl:px-40 px-2 shadow-md">
            <h1 className="text-center font-bold text-white drop-shadow-lg text-[2rem] 2xl:m-5 md:m-3 m-2">About Me</h1>
            <div className="flex flex-wrap md:flex-nowrap justify-center items-center">
                <img src={Moji} className="rounded-full border-[1px] 2xl:h-48 md:h-44 h-40 border-[#dddbdb] bg-white 2xl:m-5 md:m-3 m-2" />
