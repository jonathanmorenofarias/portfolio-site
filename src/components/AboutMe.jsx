    ...
    return (
        <div className="bg-[#03a9fc] 2xl:py-20 md:py-15 py-10 2xl:px-96 md:px-40 px-2 shadow-md">
            ...
            <div className="flex flex-wrap md:flex-nowrap justify-center items-center gap-[2rem]">
                ...
                <p className="rounded-[10px] border-[1px] border-[#b5b5b5] bg-white p-[1rem] ">I am in my final year of pursuing a degree in Computer Science at Oregon State University.
