...
const Main = () => {
    return (
      <div className="flex md:flex-row flex-col md:justify-center justify-start items-center h-[100vh] gap-4 2xl:py-20 md:py-15 py-10 2xl:px-96 md:px-40 px-2 shadow-md">
